...
export const CoordinateDisplay: React.FC<CoordinateDisplayProps> = ({
  ...
  if (!position) {
    return (
      <div className="bg-white px-3 py-1 rounded shadow text-sm">Mueva el cursor sobre el mapa</div>
    );
  }
  ...
  return <div className="bg-white px-3 py-1 rounded shadow text-sm font-mono">{displayText}</div>;
};
